const Guide = ({ startGame }) => {
  return (
    <div className="absolute flex h-screen items-center justify-center bg-black/40 inset-0">
      <div className="mx-4 flex w-fit flex-col gap-4 rounded-xl border-8 border-double border-orange-900 bg-orange-50 px-2 py-8 text-orange-900">
        ...
        <ul className="mx-4 flex list-disc flex-col gap-2 text-2xl">
        ...
        <button
          onClick={startGame}
          className="w-fit self-center rounded-xl border-2 border-orange-800 bg-orange-200/90 px-8 py-2 text-3xl font-bold hover:bg-orange-300"
        >
          Start
        </button>
      </div>
